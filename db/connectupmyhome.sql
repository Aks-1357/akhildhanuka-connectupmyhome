...
--
-- Host: localhost
-- Generation Time: Jan 19, 2013 at 04:42 PM
...
--
-- Database: `connectupmyhome`
--

-- --------------------------------------------------------

--
-- Table structure for table `cnn_assets`
--

DROP TABLE IF EXISTS `cnn_assets`;
CREATE TABLE IF NOT EXISTS `cnn_assets` (
...
--
-- Dumping data for table `cnn_assets`
--

INSERT INTO `cnn_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(35, 1, 67, 68, 1, 'com_homeconnect', 'com_homeconnect', '{}');

-- --------------------------------------------------------

--
-- Table structure for table `cnn_associations`
--

DROP TABLE IF EXISTS `cnn_associations`;
CREATE TABLE IF NOT EXISTS `cnn_associations` (
...
--
-- Table structure for table `cnn_banners`
--

DROP TABLE IF EXISTS `cnn_banners`;
CREATE TABLE IF NOT EXISTS `cnn_banners` (
...
--
-- Table structure for table `cnn_banner_clients`
--

DROP TABLE IF EXISTS `cnn_banner_clients`;
CREATE TABLE IF NOT EXISTS `cnn_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `cnn_banner_tracks`
--

DROP TABLE IF EXISTS `cnn_banner_tracks`;
CREATE TABLE IF NOT EXISTS `cnn_banner_tracks` (
...
--
-- Table structure for table `cnn_categories`
--

DROP TABLE IF EXISTS `cnn_categories`;
CREATE TABLE IF NOT EXISTS `cnn_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `cnn_categories`
--

INSERT INTO `cnn_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`) VALUES
...
--
-- Table structure for table `cnn_contact_details`
--

DROP TABLE IF EXISTS `cnn_contact_details`;
CREATE TABLE IF NOT EXISTS `cnn_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `cnn_content`
--

DROP TABLE IF EXISTS `cnn_content`;
CREATE TABLE IF NOT EXISTS `cnn_content` (
...
--
-- Table structure for table `cnn_content_frontpage`
--

DROP TABLE IF EXISTS `cnn_content_frontpage`;
CREATE TABLE IF NOT EXISTS `cnn_content_frontpage` (
...
--
-- Table structure for table `cnn_content_rating`
--

DROP TABLE IF EXISTS `cnn_content_rating`;
CREATE TABLE IF NOT EXISTS `cnn_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `cnn_core_log_searches`
--

DROP TABLE IF EXISTS `cnn_core_log_searches`;
CREATE TABLE IF NOT EXISTS `cnn_core_log_searches` (
...
--
-- Table structure for table `cnn_extensions`
--

DROP TABLE IF EXISTS `cnn_extensions`;
CREATE TABLE IF NOT EXISTS `cnn_extensions` (
...
--
-- Dumping data for table `cnn_extensions`
--

INSERT INTO `cnn_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(10000, 'com_homeconnect', 'component', 'com_homeconnect', '', 1, 1, 0, 0, '{"legacy":false,"name":"com_homeconnect","type":"component","creationDate":"2013-01-02","author":"vinayak","copyright":"Copyright (C) 2013. All rights reserved.","authorEmail":"vinayakbardale@gmail.com","authorUrl":"http:\\/\\/","version":"1.0.0","description":"Home Connect","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10001, 'Homeconnect', 'module', 'mod_homeconnect', '', 0, 1, 0, 0, '{"legacy":false,"name":"Homeconnect","type":"module","creationDate":"Saturday 19th of January 2013 10:50:32 AM","author":"Akshay","copyright":"Copyright (C) 2005 - 2011 Open Source Matters. All rights reserved.","authorEmail":"EMAIL","authorUrl":"URL","version":"1.0","description":"","group":""}', '{"cache":"0"}', '', '', 0, '0000-00-00 00:00:00', 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `cnn_finder_filters`
--

DROP TABLE IF EXISTS `cnn_finder_filters`;
CREATE TABLE IF NOT EXISTS `cnn_finder_filters` (
...
--
-- Table structure for table `cnn_finder_links`
--

DROP TABLE IF EXISTS `cnn_finder_links`;
CREATE TABLE IF NOT EXISTS `cnn_finder_links` (
...
--
-- Table structure for table `cnn_finder_links_terms0`
--

DROP TABLE IF EXISTS `cnn_finder_links_terms0`;
CREATE TABLE IF NOT EXISTS `cnn_finder_links_terms0` (
...
--
-- Table structure for table `cnn_finder_links_terms1`
--

DROP TABLE IF EXISTS `cnn_finder_links_terms1`;
CREATE TABLE IF NOT EXISTS `cnn_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cnn_finder_links_terms2`
--

DROP TABLE IF EXISTS `cnn_finder_links_terms2`;
CREATE TABLE IF NOT EXISTS `cnn_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cnn_finder_links_terms3`
--

DROP TABLE IF EXISTS `cnn_finder_links_terms3`;
CREATE TABLE IF NOT EXISTS `cnn_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cnn_finder_links_terms4`
--

DROP TABLE IF EXISTS `cnn_finder_links_terms4`;
CREATE TABLE IF NOT EXISTS `cnn_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cnn_finder_links_terms5`
--

DROP TABLE IF EXISTS `cnn_finder_links_terms5`;
CREATE TABLE IF NOT EXISTS `cnn_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cnn_finder_links_terms6`
--

DROP TABLE IF EXISTS `cnn_finder_links_terms6`;
CREATE TABLE IF NOT EXISTS `cnn_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cnn_finder_links_terms7`
--

DROP TABLE IF EXISTS `cnn_finder_links_terms7`;
CREATE TABLE IF NOT EXISTS `cnn_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cnn_finder_links_terms8`
--

DROP TABLE IF EXISTS `cnn_finder_links_terms8`;
CREATE TABLE IF NOT EXISTS `cnn_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cnn_finder_links_terms9`
--

DROP TABLE IF EXISTS `cnn_finder_links_terms9`;
CREATE TABLE IF NOT EXISTS `cnn_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cnn_finder_links_termsa`
--

DROP TABLE IF EXISTS `cnn_finder_links_termsa`;
CREATE TABLE IF NOT EXISTS `cnn_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cnn_finder_links_termsb`
--

DROP TABLE IF EXISTS `cnn_finder_links_termsb`;
CREATE TABLE IF NOT EXISTS `cnn_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cnn_finder_links_termsc`
--

DROP TABLE IF EXISTS `cnn_finder_links_termsc`;
CREATE TABLE IF NOT EXISTS `cnn_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cnn_finder_links_termsd`
--

DROP TABLE IF EXISTS `cnn_finder_links_termsd`;
CREATE TABLE IF NOT EXISTS `cnn_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cnn_finder_links_termse`
--

DROP TABLE IF EXISTS `cnn_finder_links_termse`;
CREATE TABLE IF NOT EXISTS `cnn_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cnn_finder_links_termsf`
--

DROP TABLE IF EXISTS `cnn_finder_links_termsf`;
CREATE TABLE IF NOT EXISTS `cnn_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `cnn_finder_taxonomy`
--

DROP TABLE IF EXISTS `cnn_finder_taxonomy`;
CREATE TABLE IF NOT EXISTS `cnn_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `cnn_finder_taxonomy`
--

INSERT INTO `cnn_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `cnn_finder_taxonomy_map`
--

DROP TABLE IF EXISTS `cnn_finder_taxonomy_map`;
CREATE TABLE IF NOT EXISTS `cnn_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `cnn_finder_terms`
--

DROP TABLE IF EXISTS `cnn_finder_terms`;
CREATE TABLE IF NOT EXISTS `cnn_finder_terms` (
...
--
-- Table structure for table `cnn_finder_terms_common`
--

DROP TABLE IF EXISTS `cnn_finder_terms_common`;
CREATE TABLE IF NOT EXISTS `cnn_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Dumping data for table `cnn_finder_terms_common`
--

INSERT INTO `cnn_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `cnn_finder_tokens`
--

DROP TABLE IF EXISTS `cnn_finder_tokens`;
CREATE TABLE IF NOT EXISTS `cnn_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `cnn_finder_tokens_aggregate`
--

DROP TABLE IF EXISTS `cnn_finder_tokens_aggregate`;
CREATE TABLE IF NOT EXISTS `cnn_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `cnn_finder_types`
--

DROP TABLE IF EXISTS `cnn_finder_types`;
CREATE TABLE IF NOT EXISTS `cnn_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `cnn_homeconnect`
--
...
--
-- Table structure for table `cnn_languages`
--

DROP TABLE IF EXISTS `cnn_languages`;
CREATE TABLE IF NOT EXISTS `cnn_languages` (
...
--
-- Dumping data for table `cnn_languages`
--

INSERT INTO `cnn_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 0, 1);

-- --------------------------------------------------------

--
-- Table structure for table `cnn_menu`
--

DROP TABLE IF EXISTS `cnn_menu`;
CREATE TABLE IF NOT EXISTS `cnn_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `cnn_menu`
--

INSERT INTO `cnn_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `ordering`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
(102, 'main', 'COM_HOMECONNECT', 'com-homeconnect', '', 'com-homeconnect', 'index.php?option=com_homeconnect', 'component', 0, 1, 1, 10000, 0, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_homeconnect/assets/images/s_com_homeconnect.png', 0, '', 43, 46, 0, '', 1),
(103, 'main', 'COM_HOMECONNECT_TITLE_HOMECONNECTS', 'com-homeconnect-title-homeconnects', '', 'com-homeconnect/com-homeconnect-title-homeconnects', 'index.php?option=com_homeconnect&view=homeconnects', 'component', 0, 102, 2, 10000, 0, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_homeconnect/assets/images/s_homeconnects.png', 0, '', 44, 45, 0, '', 1),
(104, 'mainmenu', 'Home Connect', 'home-connect', '', 'home-connect', 'index.php?option=com_homeconnect&view=createbundle', 'component', 1, 1, 1, 10000, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 47, 48, 0, '*', 0);

-- --------------------------------------------------------

--
-- Table structure for table `cnn_menu_types`
--

DROP TABLE IF EXISTS `cnn_menu_types`;
CREATE TABLE IF NOT EXISTS `cnn_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `cnn_menu_types`
--

INSERT INTO `cnn_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Table structure for table `cnn_messages`
--

DROP TABLE IF EXISTS `cnn_messages`;
CREATE TABLE IF NOT EXISTS `cnn_messages` (
...
--
-- Table structure for table `cnn_messages_cfg`
--

DROP TABLE IF EXISTS `cnn_messages_cfg`;
CREATE TABLE IF NOT EXISTS `cnn_messages_cfg` (
...
--
-- Table structure for table `cnn_modules`
--

DROP TABLE IF EXISTS `cnn_modules`;
CREATE TABLE IF NOT EXISTS `cnn_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `cnn_modules`
--

INSERT INTO `cnn_modules` (`id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
(87, 'Home Connect', '', '', 1, 'position-7', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_homeconnect', 1, 1, '{"moduleclass_sfx":"","cache":"0"}', 0, '*');

-- --------------------------------------------------------

--
-- Table structure for table `cnn_modules_menu`
--

DROP TABLE IF EXISTS `cnn_modules_menu`;
CREATE TABLE IF NOT EXISTS `cnn_modules_menu` (
...
--
-- Dumping data for table `cnn_modules_menu`
--

INSERT INTO `cnn_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `cnn_newsfeeds`
--

DROP TABLE IF EXISTS `cnn_newsfeeds`;
CREATE TABLE IF NOT EXISTS `cnn_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `cnn_overrider`
--

DROP TABLE IF EXISTS `cnn_overrider`;
CREATE TABLE IF NOT EXISTS `cnn_overrider` (
...
--
-- Table structure for table `cnn_redirect_links`
--

DROP TABLE IF EXISTS `cnn_redirect_links`;
CREATE TABLE IF NOT EXISTS `cnn_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `cnn_schemas`
--

DROP TABLE IF EXISTS `cnn_schemas`;
CREATE TABLE IF NOT EXISTS `cnn_schemas` (
...
--
-- Dumping data for table `cnn_schemas`
--

INSERT INTO `cnn_schemas` (`extension_id`, `version_id`) VALUES
(700, '2.5.8');

-- --------------------------------------------------------

--
-- Table structure for table `cnn_session`
--

DROP TABLE IF EXISTS `cnn_session`;
CREATE TABLE IF NOT EXISTS `cnn_session` (
...
--
-- Dumping data for table `cnn_session`
--

INSERT INTO `cnn_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`, `usertype`) VALUES
('uieumkpcm0i8t4v5lv49d355o4', 0, 1, '1358609476', '__default|a:8:{s:15:"session.counter";i:99;s:19:"session.timer.start";i:1358590755;s:18:"session.timer.last";i:1358609463;s:17:"session.timer.now";i:1358609476;s:22:"session.client.browser";s:65:"Mozilla/5.0 (Windows NT 6.1; rv:18.0) Gecko/20100101 Firefox/18.0";s:8:"registry";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":1:{s:15:"com_homeconnect";O:8:"stdClass":1:{s:4:"edit";O:8:"stdClass":1:{s:11:"homeconnect";O:8:"stdClass":1:{s:2:"id";N;}}}}}s:4:"user";O:5:"JUser":25:{s:9:"\0*\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:8:"usertype";N;s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:0:{}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:10:"\0*\0_params";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:14:"\0*\0_authGroups";a:1:{i:0;i:1;}s:14:"\0*\0_authLevels";a:2:{i:0;i:1;i:1;i:1;}s:15:"\0*\0_authActions";N;s:12:"\0*\0_errorMsg";N;s:10:"\0*\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"1049fd5b3378bc5ee5ee053f06f93ecc";}', 0, '', '');

-- --------------------------------------------------------

--
-- Table structure for table `cnn_template_styles`
--

DROP TABLE IF EXISTS `cnn_template_styles`;
CREATE TABLE IF NOT EXISTS `cnn_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `cnn_template_styles`
--

INSERT INTO `cnn_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `cnn_updates`
--

DROP TABLE IF EXISTS `cnn_updates`;
CREATE TABLE IF NOT EXISTS `cnn_updates` (
...
--
-- Dumping data for table `cnn_updates`
--

INSERT INTO `cnn_updates` (`update_id`, `update_site_id`, `extension_id`, `categoryid`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`) VALUES
...
--
-- Table structure for table `cnn_update_categories`
--

DROP TABLE IF EXISTS `cnn_update_categories`;
CREATE TABLE IF NOT EXISTS `cnn_update_categories` (
...
--
-- Table structure for table `cnn_update_sites`
--

DROP TABLE IF EXISTS `cnn_update_sites`;
CREATE TABLE IF NOT EXISTS `cnn_update_sites` (
...
--
-- Dumping data for table `cnn_update_sites`
--

INSERT INTO `cnn_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 0, 1358156938),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 0, 1358156938),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist.xml', 0, 1358156938);

-- --------------------------------------------------------

--
-- Table structure for table `cnn_update_sites_extensions`
--

DROP TABLE IF EXISTS `cnn_update_sites_extensions`;
CREATE TABLE IF NOT EXISTS `cnn_update_sites_extensions` (
...
--
-- Dumping data for table `cnn_update_sites_extensions`
--

INSERT INTO `cnn_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600);
...
--
-- Table structure for table `cnn_usergroups`
--

DROP TABLE IF EXISTS `cnn_usergroups`;
CREATE TABLE IF NOT EXISTS `cnn_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Dumping data for table `cnn_usergroups`
--

INSERT INTO `cnn_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 20, 'Public'),
(2, 1, 6, 17, 'Registered'),
(3, 2, 7, 14, 'Author'),
(4, 3, 8, 11, 'Editor'),
...
--
-- Table structure for table `cnn_users`
--

DROP TABLE IF EXISTS `cnn_users`;
CREATE TABLE IF NOT EXISTS `cnn_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `cnn_users`
--

INSERT INTO `cnn_users` (`id`, `name`, `username`, `email`, `password`, `usertype`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`) VALUES
(595, 'Super User', 'admin', 'akshay@anomaly.co.in', '2371386f080b7fa49bff8ebe5cd458ed:CCsmUWqWBHvvW7GLOQ724HiZQw4d2NdZ', 'deprecated', 0, 1, '2013-01-02 12:36:15', '2013-01-19 13:08:04', '0', '{"admin_style":"","admin_language":"","language":"","editor":"","helpsite":"","timezone":""}', '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Table structure for table `cnn_user_notes`
--

DROP TABLE IF EXISTS `cnn_user_notes`;
CREATE TABLE IF NOT EXISTS `cnn_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `cnn_user_profiles`
--

DROP TABLE IF EXISTS `cnn_user_profiles`;
CREATE TABLE IF NOT EXISTS `cnn_user_profiles` (
...
--
-- Table structure for table `cnn_user_usergroup_map`
--

DROP TABLE IF EXISTS `cnn_user_usergroup_map`;
CREATE TABLE IF NOT EXISTS `cnn_user_usergroup_map` (
...
--
-- Dumping data for table `cnn_user_usergroup_map`
--

INSERT INTO `cnn_user_usergroup_map` (`user_id`, `group_id`) VALUES
(595, 8);

-- --------------------------------------------------------

--
-- Table structure for table `cnn_viewlevels`
--

DROP TABLE IF EXISTS `cnn_viewlevels`;
CREATE TABLE IF NOT EXISTS `cnn_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `cnn_viewlevels`
--

INSERT INTO `cnn_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Table structure for table `cnn_weblinks`
--

DROP TABLE IF EXISTS `cnn_weblinks`;
CREATE TABLE IF NOT EXISTS `cnn_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
