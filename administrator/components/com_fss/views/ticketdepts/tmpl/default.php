...
<form action="<?php echo FSSRoute::x( 'index.php?option=com_fss&view=ticketdepts' );?>" method="post" name="adminForm" id="adminForm">
...
<div id="editcell">
    ...
    for ($i=0, $n=count( $this->data ); $i < $n; $i++)
    {
        ...
        $link = FSSRoute::x( 'index.php?option=com_fss&controller=ticketdept&task=edit&cid[]='. $row->id );
        ...
        <tr class="<?php echo "row$k"; ?>">
			...
			<td>
				...
				<?php } else { ?>
				<?php $link = FSSRoute::x('?option=com_fss&tmpl=component&controller=ticketdept&view=ticketdept&task=prods&ticket_dept_id=' . $row->id); ?>
