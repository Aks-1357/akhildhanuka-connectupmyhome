...
<form action="<?php echo FSSRoute::x( 'index.php?option=com_fss&view=announces' );?>" method="post" name="adminForm" id="adminForm">
...
<div id="editcell">
    ...
    for ($i=0, $n=count( $this->data ); $i < $n; $i++)
    {
        ...
        $link = FSSRoute::x( 'index.php?option=com_fss&controller=announce&task=edit&cid[]='. $row->id );
