...
<div>
	<fieldset class="adminform">
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="title" id="title" size="32" maxlength="250" value="<?php echo JViewLegacy::escape($this->announce->title);?>" />
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="subtitle" id="subtitle" size="32" maxlength="250" value="<?php echo JViewLegacy::escape($this->announce->subtitle);?>" />
			</td>
		</tr>
		<tr>
			<td width="135" align="right" class="key">
			...
			<td>
				...
				echo $editor->display('body', $text, '550', '400', '60', '20', array('pagebreak'));
				?>
            </td>
