...
<div>
	<fieldset class="adminform">
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="title" id="title" size="32" maxlength="250" value="<?php echo JViewLegacy::escape($this->ticketdept->title);?>" />
			</td>
			<td>
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="description" id="description" size="32" maxlength="250" value="<?php echo JViewLegacy::escape($this->ticketdept->description);?>" />
			</td>
			<td>
...
<input type="hidden" name="translation" id="translation" value="<?php echo htmlEntities($this->ticketdept->translation); ?>" />
</form>
