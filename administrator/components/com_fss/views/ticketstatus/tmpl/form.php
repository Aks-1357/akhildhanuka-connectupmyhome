...
<div>
	<fieldset class="adminform">
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="title" id="title" size="32" maxlength="250" value="<?php echo JViewLegacy::escape($this->ticketstatus->title);?>" />
			</td>
			<td>
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="userdisp" id="userdisp" size="32" maxlength="250" value="<?php echo JViewLegacy::escape($this->ticketstatus->userdisp);?>" />
			</td>
			<td>
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="color" id="color" size="32" maxlength="250" value="<?php echo JViewLegacy::escape($this->ticketstatus->color);?>" />
			</td>
		</tr>
...
<input type="hidden" name="translation" id="translation" value="<?php echo htmlEntities($this->ticketstatus->translation); ?>" />
