...
<form action="<?php echo FSSRoute::x( 'index.php?option=com_fss&view=ticketpris' );?>" method="post" name="adminForm" id="adminForm">
...
<div id="editcell">
    ...
    for ($i=0, $n=count( $this->data ); $i < $n; $i++)
    {
        ...
        $link = FSSRoute::x( 'index.php?option=com_fss&controller=ticketpri&task=edit&cid[]='. $row->id );
        ...
        <tr class="<?php echo "row$k"; ?>">
			...
			<td>
			    <a href="<?php echo $link; ?>"><?php echo $row->color; ?></a>
			</td>
