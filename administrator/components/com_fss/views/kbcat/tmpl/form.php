...
<div>
	<fieldset class="adminform">
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="title" id="title" size="32" maxlength="250" value="<?php echo JViewLegacy::escape($this->kbcat->title);?>" />
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<?php
				$editor =& JFactory::getEditor();
				echo $editor->display('description', $this->kbcat->description, '550', '200', '60', '20', array('pagebreak', 'readmore'));
				?>
            </td>
