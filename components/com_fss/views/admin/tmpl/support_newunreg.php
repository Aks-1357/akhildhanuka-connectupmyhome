...
<div class="contentheading"><?php echo JText::_("CREATE_TICKET_FOR_UNREGISTERED_USER"); ?></div>
<div class="fss_spacer"></div>
<form action="<?php echo FSSRoute::x('&view=ticket&layout=open&admincreate=2'); ?>" method="post" >
<table class="fss_table" cellpadding="0" cellspacing="0"> 
	<tr>
		<th><?php echo JText::_("EMAIL_ADDRESS"); ?></th>
		<td><input name="admin_create_email" class="inputbox"></td>
	</tr>
	<tr>
		<th><?php echo JText::_("NAME"); ?></th>
		<td><input name="admin_create_name" class="inputbox"></td>
	</tr>
	<tr>
