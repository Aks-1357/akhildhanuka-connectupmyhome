...
<?php ('_JEXEC') or die('Restricted access'); ?>
	    	<div class='faq_category <?php if ($this->view_mode_cat == "accordian") echo "accordion_toggler_$acl"; ?>' <?php if ($this->view_mode_cat == "accordian") echo " style='cursor: pointer;' "; ?> >
	    		...
	    		<div class='faq_category_image'>
	    			...
	    			<?php else: ?>
	    			<img src='<?php echo JURI::root( true ); ?>/images/fss/faqcats/<?php echo $cat['image']; ?>' width='64' height='64'>
	    			<?php endif; ?>
	    		</div>
	    		<?php endif; ?>
				...
				<div class='faq_category_head'>
					...
					<?php if ($this->view_mode_cat == "popup") : ?>
						...
						<a class="modal fss_highlight" href='<?php echo FSSRoute::x( '&tmpl=component&limitstart=&catid=' . $cat['id'] . '&view_mode=' . $this->view_mode_incat ); ?>' rel="{handler: 'iframe', size: {x: 650, y: 375}}">
						   <?php echo $cat['title'] ?>
						</a>
					...
					<?php else: ?>
						...
						<A class="fss_highlight" href='<?php echo FSSRoute::x( '&limitstart=&catid=' . $cat['id'] );?>'><?php echo $cat['title'] ?></a>
			...
			<div class='faq_category_faqlist <?php if ($this->view_mode_cat == "accordian") echo "accordion_content_$acl"; ?>' id="faq_category_faqlist">
				...
				<?php if (array_key_exists('faqs',$cat) && count($cat['faqs']) > 0): ?>
					...
					<?php endforeach; ?>	
				<?php else: ?>
					<div class="fss_faq_question" style="padding-bottom:5px;"><?php echo JText::_("NO_FAQS_FOUND_IN_THIS_CATEGORY");?></div>
					<div class="fss_faq_answer"></div>
				<?php endif; ?>
