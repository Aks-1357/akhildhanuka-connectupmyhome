...
jQuery(document).ready(function () {
    ...
    if (jQuery('.fsj_tip').length > 0)
        jQuery('.fsj_tip').tooltip({ position: "bottom right", effect: 'fade', tipClass: 'fss_tooltip' });
    if (jQuery('.fsj_tip_wide').length > 0) {
        jQuery('.fsj_tip_wide').tooltip({ position: "bottom center", effect: 'fade', tipClass: 'fss_tooltip_wide' });
    }
});
