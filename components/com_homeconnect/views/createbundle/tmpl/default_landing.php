...
<div id="landing_div" style="width: 94%; display: none; float: left; border: 1px solid #ccc; padding: 5px 20px 20px;">
	...
	<div style="width: 90%; margin-top: 15px; text-align: center;">
		<div id="create_bundle" style="cursor: pointer; border: 1px solid #ccc; padding: 15px 0; width: 40%; float: left;" onClick="javascript:controllerObj.oncreatebundle('main_accordian_div','recommended_div','main_category_div');">Create your Own Bundle</div>
		<div style="margin: 0 20px; padding: 15px 0; width: 10%; float: left;"> - OR - </div>
		<div id="recommended_bundle" style="cursor: pointer; border: 1px solid #ccc; padding: 15px 0; width: 40%; float: left;" onClick="javascript:controllerObj.oncreatebundle('main_accordian_div','main_category_div','recommended_div');">Recommended Bundle</div>
	</div>
