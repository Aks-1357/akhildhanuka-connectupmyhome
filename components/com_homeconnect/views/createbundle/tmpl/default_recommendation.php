<?php
	...
	//var_dump($this->recommended);exit;
...
<div id="recommended_div">
	<div id="rec_error_message" ></div>
	
    
		<!--<h2> Your Selection </h2>-->

	
		<div class="selected_product_div" style="display:none">
		
	
    	<div class="selection_div_wrap">
	
    		<div id="new_selected_product_div" class="selected_product_div">
    		...
    		<!--<input type="radio"  name="confirm" value="ignore">ignore
    		<input type="radio"  name="confirm" value="confirm">confirm
        --></div>
        <div style="margin-top:-60px; margin-left: -65px; float:left"><input type="checkbox" id="confirmnewselection" onclick="javascript:controllerObj.confirmSelection('recommended_div', 'installation_div','<?php echo JURI::base().'images/basketimages/';?>','new_selection');"/>
		</div>
		<button type="button" class="nextbutton" id="clear_selection" onclick ="javascript:controllerObj.clearSelection()">Clear Selection</button>
	...
	<div id="our_recommendation_div">
		...
		<h2> <div style="margin-top:10px;float:left">Our Recommendations </div>
                <div class="icon" style="width:87px; margin:5px 56px 0 0;"><img src="<?php echo JURI::base().'templates/'.$app->getTemplate().'/images/tv.png';?>"/></div> 
        
        <div class="icon" style="margin-top:5px;"><img src="<?php echo JURI::base().'templates/'.$app->getTemplate().'/images/music.png';?>"/></div>
        
        <div class="icon" style="margin-top:5px;"><img src="<?php echo JURI::base().'templates/'.$app->getTemplate().'/images/game.png';?>"/></div>
        
        <div class="icon" style="margin-top:5px;"><img src="<?php echo JURI::base().'templates/'.$app->getTemplate().'/images/broadband.png';?>"/></div>

        
        <div class="installation_div_arrow">
		<div style="display:inline-block" class="nextbutton" onclick="javascript:controllerObj.confirmRecommendedSelection('recommended_div', 'installation_div','<?php echo JURI::base().'images/basketimages/';?>','new_selection');">
			Next
		</div>
				   ...
				   foreach($bundle as $bundle1)
				   {
				   	  if(strcasecmp($bundle1->description, "Lowest price bundle") == 0)
				   	  {
								...
								<div id="lower_<?php echo $r;?>_1" class="RecProduct addDraggableProduct">
									...
									?>
									<div class="lower_<?php echo $r;?>_1" data-product-detail="<?php echo JFilterOutput::stringURLSafe($producttype).','.JFilterOutput::stringURLSafe($supplier).','.JFilterOutput::stringURLSafe($title).','.JFilterOutput::stringURLSafe($bundle1->tV->id).','.$contract.','.$quota.','.$mprice.','.$price.','.$equipmentPrice.','.$installationPrice; ?>">
...
<!--								<div class="RecDevider">-->
								...
								<div id="best_<?php echo $b;?>_4" class="RecProduct addDraggableProduct">
									<?php   $supplier =$bundle1->broadband->supplier;
											...
											$id = $bundle1->broadband->id;
									?>
									<div class="best_<?php echo $b;?>_4" data-product-detail="<?php echo JFilterOutput::stringURLSafe("broadband").','.JFilterOutput::stringURLSafe($supplier).','.JFilterOutput::stringURLSafe($title).','.JFilterOutput::stringURLSafe($bundle1->broadband->id).','.$contract.','.$quota.','.$mprice.','.$price.','.$equipmentPrice.','.$installationPrice; ?>">
									   <ul class="columns" style="position: inherit !important; padding:none !important">
									    <?php 
...
<script type="text/javascript">
	allproduct = <?php echo $this->recommended;?>;
